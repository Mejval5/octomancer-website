...
(function (f) {
  if (typeof exports === 'object' && typeof module !== 'undefined') {
    module.exports = f()
} else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.Parallax = f() }
})(function () {
 ...
 var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n || e) }, l, l.exports, e, t, n, r)
} return n[o].exports
...
function runTimeout (fun) {
    ...
    try {
        ...
        try {
            ...
            return cachedSetTimeout(null, fun, 0)
        } catch (e) {
            // same as above but when it's a version of I.E. that must have the global object for 'this', hopfully our context correct otherwise it will throw a global error
            return cachedSetTimeout(this, fun, 0)
        }
    }
}
function runClearTimeout (marker) {
    ...
    try {
        ...
        try {
            // When we are in I.E. but the script has been evaled so I.E. doesn't  trust the global object when called normally
            return cachedClearTimeout(null, marker)
        } catch (e) {
            // same as above but when it's a version of I.E. that must have the global object for 'this', hopfully our context correct otherwise it will throw a global error.
            // Some versions of I.E. have different rules for clearTimeout vs setTimeout
            return cachedClearTimeout(this, marker)
        }
    }
}
var queue = []
...
var Parallax = (function () {
  function Parallax (element, options) {
    ...
    this.enableThisF = this.enableThisF.bind(this)
    this.disableThisF = this.disableThisF.bind(this)
  ...
  _createClass(Parallax, [{
    ...
    value: function initialise () {
      if (this.transform2DSupport === undefined) {
        ...
        this.transform3DSupport = helpers.transformSupport('2D')
      }
    ...
    key: 'enableThisF',
    value: function enableThisF () {
      this.enabled = true
      this.enable()
    },
  }, {
    key: 'disableThisF',
    value: function disableThisF () {
      this.enabled = false
      this.disable()
      for (var index = 0; index < this.layers.length; index++) {
        var layer = this.layers[index]
            var depthX = this.depthsX[index]
            var depthY = this.depthsY[index]
            var xOffset = 0
            var yOffset = 0
    ...
    value: function onAnimationFrame () {
      ...
      var calibratedInputX = this.inputX - this.calibrationX
          var calibratedInputY = this.inputY - this.calibrationY
      ...
      for (var index = 0; index < this.layers.length; index++) {
        var layer = this.layers[index]
            var depthX = this.depthsX[index]
            var depthY = this.depthsY[index]
            var xOffset = this.velocityX * (depthX * (this.invertX ? -1 : 1))
            var yOffset = this.velocityY * (depthY * (this.invertY ? -1 : 1))
        this.setPosition(layer, xOffset, yOffset)
      }
      this.raf = rqAnFr(this.onAnimationFrame)
    },
    ...
    value: function rotate (beta, gamma) {
      ...
      var x = (beta || 0) / MAGIC_NUMBER
          //  -90 :: 90
      var y = (gamma || 0) / MAGIC_NUMBER // -180 :: 180
